...
3. The Bellman-Ford algorithm will start automatically. 
   Relaxed edges will be highlighted in red, then green if it contain a shorter path to a node. 
   Labels beneath the node update showing the shortest known distances to the node, taken from the shortestPath array. 
